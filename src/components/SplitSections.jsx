      ...
      <div className="container mx-auto px-4">
        <div className={`flex flex-col ${imageLeft ? 'md:flex-row-reverse' : 'md:flex-row'} items-center gap-12`}>
          ...
          <div className="w-full md:w-3/5 lg:w-2/3">
            <h2 className="text-3xl font-bold mb-6 uppercase">{title}</h2>
  ...
  return (
    <>
      ...
      <SplitSection 
        ...
        media={
          <div className="flex justify-center">
            <div className="rounded-lg shadow-xl overflow-hidden w-64 h-64 aspect-square">
              <img 
      ...
      <SplitSection 
        ...
        media={
          <div className="flex justify-center">
            <div className="rounded-lg overflow-hidden shadow-xl w-64 h-48 aspect-video">
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <h3 className="text-lg font-bold mb-1">Seguridad</h3>
            </div>
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <h3 className="text-lg font-bold mb-1">Asesoría</h3>
            </div>
          </div>
        </div>
      </div>
